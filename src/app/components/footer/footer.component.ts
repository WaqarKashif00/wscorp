          ...
          <div>
            ...
            <div class="space-y-6 mb-10">
              <div class="flex items-start gap-4">
                ...
                <p class="text-gray-400 text-sm font-bold uppercase tracking-widest leading-relaxed">
                  8609 Westwood Center Dr #110, <br> Vienna, VA
                </p>
              </div>
              <div class="flex items-center gap-4">
                <span class="text-accent text-lg">✉️</span>
                <a href="mailto:info@wvservices.net" class="text-gray-400 hover:text-white transition-colors text-sm font-bold uppercase tracking-widest">
                  info&#64;wvservices.net
                </a>
              </div>
            </div>
